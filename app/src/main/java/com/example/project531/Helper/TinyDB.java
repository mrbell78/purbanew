...
public class TinyDB {
    ...
    public ArrayList<responseProduct> getListObject(String key){
        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<responseProduct> playerList =  new ArrayList<responseProduct>();
        for(String jObjString : objStrings){
            responseProduct player  = gson.fromJson(jObjString,  responseProduct.class);
    ...
    public void putListObject(String key, ArrayList<responseProduct> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(responseProduct player: playerList){
